...
<html>
    <head>
		...
		function onLoadTimeLine() {
                ...
                Timeline.createBandInfo({
                    ...
                    eventPainterParams: {
                        ...
                        stackConcurrentPreciseInstantEvents: {
                            limit: 9,
                            moreMessageTemplate:    "%0 Evénements supplémentaires",
            ...
            document.getElementById("tl").style.height = (document.getElementById("services").offsetHeight-100)+"px";
            ...
            if(url == "/fr/" || url == "/fr")
            	preUrl = "../"
            tl.loadJSON(preUrl+"event_fr.json?"+ (new Date().getTime()), function(json, url) { eventSource.loadJSON(json, url); });
        }
    ...
    <body onresize="onResizeTimeLine();">
        ...
        <div id="homes" class="x-hidden">
            ...
            <div id="home-event" class="ari-home <?php echo $eventClass ?>">
                ...
                <!--<div id="event-channel-ourselection">
                    <?php /*@ include ($config["wcm.webSite.repository"]."sites/".$site->code."/homes/event.ourSelection.html")*/?>
                </div>
        ...
        <div id="restricted-service" class="x-hidden">
            ...
            <?php
            $subject = "Je souhaite m’abonner à des services supplémentaires du fil AFP-Relaxnews";
            if (strpos("@afp.com", $CURRENT_ACCOUNT_MANAGER->email) > 0) {
                
            ?>
            <p>
                Pour vous y abonner, merci de contacter : <a href="mailto:<?php echo $CURRENT_ACCOUNT_MANAGER->email; ?>?subject=<?php echo $subject; ?>"><?php echo $CURRENT_ACCOUNT_MANAGER->email; ?></a>
            </p>
            <?php 
            ...
            ?>
            <p>
                Pour vous y abonner, merci de contacter : <a href="mailto:marketing@relaxnews.com?subject=<?php echo $subject; ?>">marketing@relaxnews.com</a>
            </p>
            <?php 
            } else {
            ...
            ?>
            <p>
                Pour vous y abonner, merci de contacter : <a href="mailto:contact@afprelaxnews.com?subject=<?php echo $subject; ?>">contact@afprelaxnews.com</a>
            </p>
            <?php 
            }
            ?>
