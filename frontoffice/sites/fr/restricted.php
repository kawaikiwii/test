...
<div class="ari-restricted">
    <div class="ari-restricted-infos">
        ...
        ?>
        <p>
            Pour vous y abonner, merci de contacter : <a href="mailto:marketing@relaxnews.com?subject=<?php echo $subject; ?>">marketing@relaxnews.com / +33 1 53 19 89 70</a>
        </p>
        <?php 
        } else {
	...
	<div class="ari-restricted-access">
        ...
        if ($site->isAllowed()) {
            ...
            foreach ($services as $service) {
                if ($service == "event")
                    $serv_event = getConst(_BIZ_EVENT);
