...
{if $news.siteId == 5 || $news.siteId == 4}
...
{foreach from=$formats.width item=width}
					<tr>
						...
						<td align="center" valign="middle">
							...
							<a href="{$urlDl}download.php?id={$related.relation.destinationId}&format={$width.format}" target="_blank"><img src="{$config.wcm.webSite.urlRepository}images/default/16x16/disk_blue.png" title="{'_DOWNLOAD_PICTURES'|constant}" /></a>
						</td>
