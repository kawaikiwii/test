...
<div style="display:none">
	...
	<input type="hidden" name="schedule_event_destinationId" id="schedule_event_destinationId" value="{$bizobject.id}" />
	    ...
	    <img src="{$config.wcm.webSite.urlRepository}illustration/photo/{$bizobject.createdAt|date_format:"%Y/%m/%d"}/{$bizobject.thumbnailPic}" alt="" style="margin-left: 46px; margin-top: 4px"/>
	</div>
