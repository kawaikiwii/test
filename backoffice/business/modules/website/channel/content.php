 ...
 * Channel Content
 *
 * Display all the content of the channel (forced or by date AND result of the request)
 *
 */
    $bizobject = wcmMVC_Action::getContext();
    
    //save channel in the session for ajax calls

    $prefix = "_wcm_channelRel_";
    ...
    wcmGUI::renderBooleanField('fixedContent', false, _BIZ_FORCED_CHANNEL);
    ...
    */
    ...
    wcmGUI::renderTextField('newquery', isset($search_query['query'])?$search_query['query']:null, _BIZ_NEW_QUERY);
    ...
    echo '<ul><li>';
    echo '<a href="javascript://" onclick="buildQuery()" class="list-builder">' . _BIZ_BUILD_QUERY . '</a>';
    echo '</li></ul>';
    wcmGUI::closeFieldset();
    
    
    wcmGUI::openFieldset(_BIZ_CONTENT);
    wcmModule('business/relationship/mainchannel', 
