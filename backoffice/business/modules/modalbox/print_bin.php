...
/**
 * Project:     WCM
 * File:        modules/modalbox/print_bin.php
 *
...
<form onsubmit="return false;">
	...
	$templatesPage = array_flip($project->generator->getTemplatesByPath('print/'));
...
<ul class="toolbar">
    ...
    <li><a href= "#" onclick="window.open('<?php echo $bo_url;?>business/popup/print_panier.php?binid=<?php echo $id;?>&template='+$('template_choice').value,'exportbin','resizable=disallow,scrollbars=1,location=0,status=1,toolbar=0,width=800,height=400'); closemodal(); return false;" class="save"><?php echo _BIZ_APPROVE;?></a></li>
</ul>
<?php
        }
        else 
