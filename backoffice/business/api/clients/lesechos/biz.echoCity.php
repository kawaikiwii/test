...
class echoCity extends bizobject
{
	...
	*/
    ...
    static function getPositionByAddress($title, $line, $postalCode, $city, $country)
    {
		...
		// ATTENTION changement d'URL, on passe par un script relais sur le serveur de dev car le serveur de prod semble Blacklisté.
		$url = "http://dev.bo.afprelax.net/business/api/clients/lesechos/googleMapRelay.php?address=".$address;
		//wcmTrace("geoloc : ".$url);	 
