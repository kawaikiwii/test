...
switch($command)
{
    ...
    case "account":
	wcmModule('business/modalbox/account_edit',array("action" => $kind, "id" => $id, "fullText" => $input, "type" => $type, "order" => $order));
        break;
    case "distributionChannel":
	wcmModule('business/modalbox/distributionChannel_edit',array("action" => $kind, "id" => $id, "exportRuleId" => $input));
        break;
    case "task":
	wcmModule('business/modalbox/task_edit',array("action" => $kind, "id" => $id));
        break;
    case "task_logs":
	wcmModule('business/modalbox/task_logs',array("action" => $kind, "id" => $id));
        break;
    case "alerte":
	wcmModule('business/modalbox/alerte',array("action" => $kind, "id" => $id));
        break;
    case "sendmdp":
	wcmModule('business/modalbox/sendmdp',array("action" => $kind, "id" => $id));
        break;
    case "permissions":
	wcmModule('business/modalbox/permissions',array("action" => $kind, "id" => $id));
        break;
   case "choosePhoto":
	wcmModule('business/modalbox/choosePhoto');
        break;
    case "choosePhotoOTV":
	wcmModule('business/modalbox/choosePhotoOTV');
        break;
    case "chooseFileLesEchos":
	wcmModule('business/modalbox/chooseFileLesEchos');
        break;
    case "gridlist":
	wcmModule('business/modalbox/gridlist', array("id" => $id));             
        break;
    case "cityUpdate":
	wcmModule('business/modalbox/updateCity', array("id" => $id));
        break;
