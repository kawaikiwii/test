...
//        echo '</li>';
        echo '<li onclick="document.getElementById(\'countryCode\').value =\''.$enum->ISO.'\';document.getElementById(\'countryId\').value =\''.$enum->geonameId.'\';cityUpdate(\''.$enum->ISO.'\');" id="'.$enum->geonameId.'" style="display: block; -moz-border-radius: 3px;padding: 0 100px 0 5px;cursor: pointer;margin-top: 2px;" title="'.$enum->country.' ('.$enum->ISO.')">';
        echo $enum->country;
        echo '</li>';
    }
    $enum->endEnum();
