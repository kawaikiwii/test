 ...
 */
    ...
    // Execute action
    wcmMVC_Action::execute('business/folder', array('class' => 'folder'));
    ...
    $tabs->addTab('browse', _BROWSE, true, folder::renderBrowseFoldersPanelForGUI());
    ...
    $tabs = new wcmAjaxTabs('folder', true);
    $tabs->addTab('t1', _BIZ_OVERVIEW, false, null, wcmModuleURL('business/shared/overview'));
    $tabs->addTab('t2', _BIZ_PROPERTIES, true, null, wcmModuleURL('business/website/folder/properties'));
    $tabs->addTab('t3', _BIZ_CONTENT, false, null, wcmModuleURL('business/website/folder/content'));
    $tabs->addTab('t4', _BIZ_SITES, false, null, wcmModuleURL('business/website/folder/universPerm'));
