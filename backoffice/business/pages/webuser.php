 ...
 */
    ...
    // Execute action
    wcmMVC_Action::execute('business/webuser', array('class' => 'webuser'));
    ...
    $tabs = new wcmAjaxTabs('webuser', true);
    $tabs->addTab('t1', _PROPERTIES, true, null, wcmModuleURL('business/ugc/webuser/properties'));
    if ($bizobject->id)
        $tabs->addTab('t2', _BIZ_SUBSCRIPTIONS, false, null, wcmModuleURL('business/ugc/webuser/subscriptions'));
    // @todo : contributions
    //$tabs->addTab('t3', _BIZ_WEBUSER_CONTRIBUTIONS, true, null, wcmModuleURL('business/show_contributions'));
