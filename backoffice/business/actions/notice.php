 ...
 */
class noticeAction extends wcmMVC_BizAction
{
	...
	{
		if ( isset ($_REQUEST['content_notice_title']))
		{
			$contentsTitle = getArrayParameter($_REQUEST, 'content_notice_title');
			$contentsDescription = getArrayParameter($_REQUEST, 'content_notice_description');
			$contentsText = getArrayParameter($_REQUEST, 'content_notice_text');
			$titleSigns = getArrayParameter($_REQUEST, 'content_notice_titleSigns');
			$titleWords = getArrayParameter($_REQUEST, 'content_notice_titleWords');
			$descriptionSigns = getArrayParameter($_REQUEST, 'content_notice_descriptionSigns');
			$descriptionWords = getArrayParameter($_REQUEST, 'content_notice_descriptionWords');
			$textSigns = getArrayParameter($_REQUEST, 'content_notice_textSigns');
			$textWords = getArrayParameter($_REQUEST, 'content_notice_textWords');
