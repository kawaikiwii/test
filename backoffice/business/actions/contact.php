 ...
 */
class contactAction extends wcmMVC_BizAction
{
    /**
     * onSave
     *
    ...
    protected function onSave($session, $project)
    {
        ...
        {
            $this->redirect(wcmModuleURL('business/subForms/createContact',
            array ('uid'=>$_REQUEST['_redirect'], 'contactId' => $this->context->id)
            ));
        }
    }	
}
