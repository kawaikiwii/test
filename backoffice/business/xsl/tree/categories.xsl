            ...
            <nobr>
                <td>
                    <img alt="" width="16" height="16" border="0" style="cursor:pointer">
                        <xsl:attribute name="onclick">doTreeCategoriesNode('<xsl:value-of select="@id"/>','','reload')</xsl:attribute>
                            <xsl:attribute name="src">img/icons/<xsl:value-of select="icon"/></xsl:attribute>
                    </img>
                </td>
                <td>
                        <h2><a>
                            <xsl:attribute name="href">javascript:doTreeCategoriesNode('<xsl:value-of select="@id"/>','','reload')</xsl:attribute>
        ...
        <tr>
            ...
            <td>
                ...
                <xsl:when test="@expanded = '1'">
                    <img alt="" width="16" height="16" border="0" style="cursor:pointer">
                        <xsl:attribute name="onclick">doTreeCategoriesNode('<xsl:value-of select="tree"/>', '<xsl:value-of select="@path"/>', 'collapse')</xsl:attribute>
                        <xsl:attribute name="src">img/collapse.gif</xsl:attribute>
                    </img>
                </xsl:when>
                <xsl:otherwise>
                    <img alt="" width="16" height="16" border="0" style="cursor:pointer">
                        <xsl:attribute name="onclick">doTreeCategoriesNode('<xsl:value-of select="tree"/>', '<xsl:value-of select="@path"/>', 'expand')</xsl:attribute>
            ...
            <td>
                <img alt="" width="16" height="16" border="0" style="cursor:pointer">
                    <xsl:attribute name="onclick">doTreeCategoriesNode('<xsl:value-of select="tree"/>', '<xsl:value-of select="@path"/>', 'refresh')</xsl:attribute>
                    <xsl:attribute name="src">img/icons/<xsl:value-of select="icon"/></xsl:attribute>
                </img>
            </td>
            <td>
                <nobr>
                    <a>
                        ...
                        <xsl:attribute name="href">javascript:doTreeCategoriesNode('<xsl:value-of select="tree"/>', '<xsl:value-of select="@path"/>', 'select')</xsl:attribute>
                        <xsl:value-of select="caption"/>
                    </a>
                </nobr>
            </td>
