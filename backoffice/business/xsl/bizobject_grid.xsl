    ...
    <div class="box">
        ...
        <div class="metadata">
            <table>
                ...
                <tr>
                    <th><b><xsl:value-of select="child::node()/className"/></b></th>
					<td><xsl:value-of select="child::node()/title"/></td>
                </tr>
                <tr>
                    <th><xsl:value-of select="php:function('constant', string('_BIZ_SOURCE'))"/></th>
                    <td><xsl:value-of select="child::node()/source"/></td>
                </tr>
                <tr>
                    <th><xsl:value-of select="php:function('constant', string('_BIZ_CREATED_AT'))"/></th>
                    <td><xsl:value-of select="child::node()/createdAt"/></td>
                </tr>
                <tr>
                    <th><xsl:value-of select="php:function('constant', string('_BIZ_MODIFIED_AT'))"/></th>
                    <td><xsl:value-of select="child::node()/modifiedAt"/></td>
                </tr>
