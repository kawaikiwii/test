...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
    <div class="row">
        ...
        <div class="sysinfo">
            <ul>
                <li><xsl:value-of select="child::node()/workflowState"/></li>
                <li>
                    <xsl:value-of select="php:function('constant', string('_BIZ_CREATED_BY'))"/>
                        <a href="#">
                    ...
                    <xsl:value-of select="php:function('constant', string('_BIZ_ON'))"/>
                        <xsl:value-of select="child::node()/createdAt"/>
                </li>
                <li>
                    <xsl:value-of select="php:function('constant', string('_BIZ_MODIFIED_BY'))"/>
                        <a href="#">
                    ...
                    <xsl:value-of select="php:function('constant', string('_BIZ_ON'))"/>
                        <xsl:value-of select="child::node()/modifiedAt"/>
                </li>
            </ul>
        ...
        <div class="preview article">
            ...
            <h3><xsl:value-of select="child::node()/title"/></h3>
            <p>
                <xsl:value-of select="php:function('constant', string('_BIZ_CREATED_BY'))"/> 
                    <cite>
                        <xsl:if test="$createdByUserName = '_ADMINISTRATOR'">
            ...
            <h4>Abstract</h4>
            <p>
            <xsl:value-of select="child::node()/abstract"/>
            </p>
        ...
        <div class="metadata">
            ...
            <table>
                <tr>
                    <td valign="top"><h4>Folders</h4></td>
                    <td valign="top">
                            <ul>
                            <li><a href="">1000-3242</a></li>
                            <li><a href="">1000-3242</a></li>
                            <li><a href="">1000-3242</a></li>
                            <li><a href="">1000-3242</a></li>
                            <li><a href="">1000-3242</a></li>
                ...
                <tr>
                    <td valign="top"><h4>Tags</h4></td>
                    <td valign="top">
  
                        <ul>
                            <li><a href="">space</a></li>
                            <li><a href="">rahayu saraswati</a></li>
                            <li><a href="">dr. phil</a></li>
                            <li><a href="">national institute on drug abuse </a></li>
                            <li><a href="">singapore</a></li>
                            <li><a href="">rafael abreu</a></li>
                ...
                <tr>
                    <td valign="top"><h4>Concepts</h4></td>
                    <td valign="top">
  
                        <ul>
                            <li><a href="">nasa</a></li>
                            <li><a href="">national oceanic and atmospheric administration</a></li>
                            <li><a href="">new orange</a></li>
                            <li><a href="">scientists</a></li>
                            <li><a href="">natalee holloway</a></li>
                            <li><a href="">space</a></li>
                            <li><a href="">rahayu saraswati</a></li>
                            <li><a href="">dr. phil</a></li>
                            <li><a href="">national institute on drug abuse </a></li>
