...
<xsl:stylesheet version="1.0"
  ...
  <td><span class="article"><span><xsl:value-of select="className"/></span></span></td>
  <td class="title"><xsl:value-of select="title"/></td>
  <td class="source"><xsl:value-of select="source"/></td>
  <td class="date"><xsl:value-of select="createdAt"/></td>
  <td><a href="#">
  ...
  <td class="date"><xsl:value-of select="modifiedAt"/></td>
  <td><a href="">
