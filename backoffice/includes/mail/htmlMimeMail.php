...
* Last Modified..: $Date: 2004/11/17 11:04:35 $
...
*/
	...
	function htmlMimeMail()
	{
        ...
        */
/*
	when php script executed from cron this globals are undefined
...
*/
	...
	//var_dump($this->smtp_params);
				$smtp = &smtp::connect($this->smtp_params);
	//var_dump($smtp->errors);
