...
<body>
<div align="center">
  <h4><a href='http://www.fusioncharts.com' target='_blank'>FusionCharts Free</A> - VB ASP.Net samples</h4>  
</div>
<table width="600" border="0" cellspacing="3" cellpadding="3" class='text' align='center' style="border:1px #CCCCCC solid;">  
    <tr>
  ...
  <tr>    
    ...
    <li><a href="BasicExample/BasicDataXML.aspx">Simple Column 3D Chart with XML data hard-coded in ASP page (dataXML method) </a>&nbsp;</li>
  ...
  <tr>
    <td><b>Database + JavaScript Examples</b></td>    
  </tr>
  <tr>
    <td>
    <ul>
