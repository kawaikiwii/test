...
class DebugConnection implements Connection {
    ...
    /**
     * @var object Instance of wcmLogger
     */
    private $logger;
    
    /**
     * Sets a Logger class to use for logging.
     * The logger class must have a logVerbose() method  All messages are logged at default log level.
     * @param object $logger
     */
